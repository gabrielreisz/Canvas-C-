...
void DesenharLinha(Canva &Canva, int x1, int y1, int x2, int y2, char pixel, char cores);
void DesenharRetangulo(Canva &Canva, int x_superior_esquerdo, int y_superior_esquerdo, int largura, int altura, char pixel, char cores);
void DesenharRetanguloPreenchido(Canva &Canva, int x_superior_esquerdo, int y_superior_esquerdo, int largura, int altura, char pixel, char cores);
